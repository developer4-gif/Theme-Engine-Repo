...
const theme: Theme = {
  id: 'smart-home',
  name: 'Smart Home',
  description: 'IoT control dark — device cards, room scene buttons, energy usage rings, automation flows. Inspired by smart home control mobile apps.',
  category: 'tech',
  tags: ["tech","smarthome","iot","mobile","dark","devices","automation","control"],
  brand: { name: 'Smart Home', tagline: '', logo: '', logoAlt: 'Smart Home', favicon: '', stripeColors: ['#0EA5E9', '#0D1218', '#10B981', '#0D1218', '#0EA5E9'], stripeHeight: 3 },
  colors: {
    bg: '#0D1218', bgSecondary: '#141D26', bgTertiary: '#1C2838', panel: '#1C2838', panelSecondary: '#141D26',
    tint: 'rgba(14,165,233,0.10)', ink: '#FFFFFF', ink2: '#94B0CC', ink3: '#4A7090', rule: '#1C2838', ruleStrong: '#2A3E55',
    ...
    navBg: '#0D1218', navText: '#4A7090', navActiveText: '#0EA5E9', navActiveBg: 'rgba(14,165,233,0.10)', navActiveBorder: '#0EA5E9',
    headerBg: '#0D1218', headerText: '#FFFFFF', headerBorder: '#1C2838',
  },
  ...
  components: {
    ...
    table: { style: 'minimal', headerBg: '#141D26', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#1C2838', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#2A3E55', focusBorderColor: '#0EA5E9', bg: '#1C2838', labelSize: '12px', inputSize: '16px' },
