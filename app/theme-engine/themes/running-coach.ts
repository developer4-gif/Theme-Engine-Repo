...
const theme: Theme = {
  id: 'running-coach',
  name: 'Running Coach',
  description: 'Energetic orange running — GPS route maps, pace charts, training plans, performance rings. Inspired by running coach mobile apps.',
  category: 'health',
  tags: ["health","running","mobile","orange","energy","gps","training","pace"],
  brand: { name: 'Running Coach', tagline: '', logo: '', logoAlt: 'Running Coach', favicon: '', stripeColors: ['#FF6400', '#0F1923', '#00D4AA', '#0F1923', '#FF6400'], stripeHeight: 3 },
  colors: {
    bg: '#0F1923', bgSecondary: '#162230', bgTertiary: '#1E2E40', panel: '#1E2E40', panelSecondary: '#162230',
    tint: 'rgba(255,100,0,0.10)', ink: '#FFFFFF', ink2: '#94A8B8', ink3: '#4A6070', rule: '#1E2E40', ruleStrong: '#2C3E50',
    primary: '#FF6400', primaryHover: '#E55A00', primaryText: '#FFFFFF',
    accent1: '#FF6400', accent2: '#00D4AA', accent3: '#FFD700', accent4: '#00B0FF', accent5: '#FF3D4A',
    alert: '#FF3D4A', warn: '#FFD700', ok: '#00D4AA', info: '#00B0FF',
    navBg: '#0F1923', navText: '#4A6070', navActiveText: '#FF6400', navActiveBg: 'rgba(255,100,0,0.10)', navActiveBorder: '#FF6400',
    headerBg: '#0F1923', headerText: '#FFFFFF', headerBorder: '#1E2E40',
  },
  ...
  components: {
    ...
    table: { style: 'minimal', headerBg: '#162230', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#1E2E40', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#2C3E50', focusBorderColor: '#FF6400', bg: '#1E2E40', labelSize: '12px', inputSize: '16px' },
