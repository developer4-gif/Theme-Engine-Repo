...
const theme: Theme = {
  id: 'note-taking',
  name: 'Note Taking',
  description: 'Warm yellow notes — notebook paper feel, handwriting font accent, tag system, search-first. Inspired by note-taking & journaling mobile apps.',
  category: 'productivity',
  tags: ["productivity","notes","mobile","yellow","warm","notebook","writing","personal"],
  brand: { name: 'Note Taking', tagline: '', logo: '', logoAlt: 'Note Taking', favicon: '', stripeColors: ['#FBBF24', '#FFFDE7', '#60A5FA', '#FFFDE7', '#FBBF24'], stripeHeight: 3 },
  colors: {
    bg: '#FFFDE7', bgSecondary: '#FFF9C4', bgTertiary: '#FFF59D', panel: '#FFFFFF', panelSecondary: '#FFFDE7',
    tint: 'rgba(251,191,36,0.08)', ink: '#1A1000', ink2: '#5A4000', ink3: '#A08030', rule: '#FFE880', ruleStrong: '#FFD840',
    primary: '#FBBF24', primaryHover: '#F59E0B', primaryText: '#1A1000',
    accent1: '#FBBF24', accent2: '#60A5FA', accent3: '#10B981', accent4: '#A78BFA', accent5: '#EF4444',
    alert: '#EF4444', warn: '#10B981', ok: '#60A5FA', info: '#A78BFA',
    navBg: '#FFFDE7', navText: '#A08030', navActiveText: '#FBBF24', navActiveBg: 'rgba(251,191,36,0.10)', navActiveBorder: '#FBBF24',
    headerBg: '#FFFDE7', headerText: '#1A1000', headerBorder: '#FFE880',
  },
  typography: { fontSans: '"Lora", "Georgia", serif', fontSerif: '"Georgia", serif', fontMono: '"SF Mono", monospace', headingFont: 'serif', xs: '10px', sm: '12px', base: '14px', md: '16px', lg: '18px', xl: '22px', '2xl': '28px', '3xl': '36px', '4xl': '48px', regular: 400, medium: 500, semibold: 600, bold: 700, tight: 1.15, normal: 1.55, relaxed: 1.75, tight_ls: '-0.01em', normal_ls: '0em', wide_ls: '0.02em', wider_ls: '0.05em' },
  ...
  components: {
    ...
    table: { style: 'minimal', headerBg: '#FFF9C4', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#FFE880', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#FFD840', focusBorderColor: '#FBBF24', bg: '#FFFFFF', labelSize: '12px', inputSize: '16px' },
