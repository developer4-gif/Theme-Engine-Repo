...
const theme: Theme = {
  id: 'weather-widget',
  name: 'Weather Widget',
  description: 'Atmospheric weather — gradient sky cards, hourly forecast chips, wind speed, precipitation map. Inspired by weather mobile apps.',
  category: 'tech',
  tags: ["weather","mobile","blue","gradient","forecast","sky","atmospheric","clean"],
  brand: { name: 'Weather Widget', tagline: '', logo: '', logoAlt: 'Weather Widget', favicon: '', stripeColors: ['#FFD740', '#1565C0', '#E0E0E0', '#1565C0', '#FFD740'], stripeHeight: 3 },
  colors: {
    bg: '#1565C0', bgSecondary: '#1976D2', bgTertiary: '#1E88E5', panel: 'rgba(255,255,255,0.12)', panelSecondary: 'rgba(255,255,255,0.08)',
    tint: 'rgba(255,255,255,0.12)', ink: '#FFFFFF', ink2: 'rgba(255,255,255,0.75)', ink3: 'rgba(255,255,255,0.50)', rule: 'rgba(255,255,255,0.15)', ruleStrong: 'rgba(255,255,255,0.25)',
    primary: '#FFD740', primaryHover: '#FFC400', primaryText: '#1565C0',
    accent1: '#FFD740', accent2: '#E0E0E0', accent3: '#80DEEA', accent4: '#A5D6A7', accent5: '#FF7043',
    alert: '#FF7043', warn: '#80DEEA', ok: '#E0E0E0', info: '#A5D6A7',
    navBg: '#1565C0', navText: 'rgba(255,255,255,0.50)', navActiveText: '#FFFFFF', navActiveBg: 'rgba(255,255,255,0.15)', navActiveBorder: '#FFFFFF',
    headerBg: 'transparent', headerText: '#FFFFFF', headerBorder: 'rgba(255,255,255,0.12)',
  },
  ...
  components: {
    ...
    table: { style: 'minimal', headerBg: '#1976D2', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: 'rgba(255,255,255,0.15)', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: 'rgba(255,255,255,0.25)', focusBorderColor: '#FFD740', bg: 'rgba(255,255,255,0.12)', labelSize: '12px', inputSize: '16px' },
    ...
    stat: { radius: '12px', valueFont: 'sans', valueFontSize: '52px', accentPosition: 'none', accentWidth: '0px', bgStyle: 'solid' },
  },
