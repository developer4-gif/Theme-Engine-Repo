...
const theme: Theme = {
  id: 'messaging-app',
  name: 'Messaging App',
  description: 'Clean messaging — chat bubbles, read receipts, voice memo, inline media, online presence. Inspired by messaging & chat mobile apps.',
  category: 'social',
  tags: ["social","messaging","chat","mobile","blue","clean","bubbles","media"],
  brand: { name: 'Messaging App', tagline: '', logo: '', logoAlt: 'Messaging App', favicon: '', stripeColors: ['#2563EB', '#FFFFFF', '#25D366', '#FFFFFF', '#2563EB'], stripeHeight: 3 },
  colors: {
    bg: '#FFFFFF', bgSecondary: '#F4F4F4', bgTertiary: '#EBEBEB', panel: '#FFFFFF', panelSecondary: '#F4F4F4',
    tint: 'rgba(37,99,235,0.06)', ink: '#1A1A1A', ink2: '#555555', ink3: '#999999', rule: '#E0E0E0', ruleStrong: '#CCCCCC',
    primary: '#2563EB', primaryHover: '#1D4ED8', primaryText: '#FFFFFF',
    accent1: '#2563EB', accent2: '#25D366', accent3: '#FFA726', accent4: '#AB47BC', accent5: '#F44336',
    alert: '#F44336', warn: '#FFA726', ok: '#25D366', info: '#AB47BC',
    navBg: '#FFFFFF', navText: '#999999', navActiveText: '#2563EB', navActiveBg: 'rgba(37,99,235,0.06)', navActiveBorder: '#2563EB',
  ...
  components: {
    ...
    card: { style: 'flat', radius: '0px', padding: '20px', shadow: '0 2px 16px rgba(0,0,0,0.08)', borderWidth: '0px', accentWidth: '0px', accentPosition: 'none' },
    table: { style: 'minimal', headerBg: '#F4F4F4', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#E0E0E0', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#CCCCCC', focusBorderColor: '#2563EB', bg: '#FFFFFF', labelSize: '12px', inputSize: '16px' },
