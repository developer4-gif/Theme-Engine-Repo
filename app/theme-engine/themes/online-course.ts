...
const theme: Theme = {
  id: 'online-course',
  name: 'Online Course',
  description: 'Clean online learning — video player, course progress, chapter list, completion badges. Inspired by MOOC & online course mobile apps.',
  category: 'education',
  tags: ["education","courses","mobile","blue","clean","video","progress","learning"],
  brand: { name: 'Online Course', tagline: '', logo: '', logoAlt: 'Online Course', favicon: '', stripeColors: ['#2563EB', '#FFFFFF', '#059669', '#FFFFFF', '#2563EB'], stripeHeight: 3 },
  colors: {
    bg: '#FFFFFF', bgSecondary: '#F8FAFF', bgTertiary: '#EEF4FF', panel: '#FFFFFF', panelSecondary: '#F8FAFF',
    tint: 'rgba(37,99,235,0.06)', ink: '#0A1428', ink2: '#2A4878', ink3: '#7898C8', rule: '#C0D8F0', ruleStrong: '#A0C0E8',
    ...
    navBg: '#FFFFFF', navText: '#7898C8', navActiveText: '#2563EB', navActiveBg: 'rgba(37,99,235,0.06)', navActiveBorder: '#2563EB',
    headerBg: '#FFFFFF', headerText: '#0A1428', headerBorder: '#C0D8F0',
  },
  ...
  components: {
    ...
    table: { style: 'minimal', headerBg: '#F8FAFF', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#C0D8F0', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#A0C0E8', focusBorderColor: '#2563EB', bg: '#FFFFFF', labelSize: '12px', inputSize: '16px' },
