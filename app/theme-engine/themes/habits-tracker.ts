...
const theme: Theme = {
  id: 'habits-tracker',
  name: 'Habits Tracker',
  description: 'Warm orange habit building — daily streak grid, completion rings, motivation quotes, progress bars. Inspired by habit building mobile apps.',
  category: 'productivity',
  tags: ["productivity","habits","mobile","orange","warm","streak","progress","building"],
  brand: { name: 'Habits Tracker', tagline: '', logo: '', logoAlt: 'Habits Tracker', favicon: '', stripeColors: ['#F97316', '#FFFFFF', '#22C55E', '#FFFFFF', '#F97316'], stripeHeight: 3 },
  colors: {
    bg: '#FFFFFF', bgSecondary: '#FFF8F0', bgTertiary: '#FFEEDD', panel: '#FFFFFF', panelSecondary: '#FFF8F0',
    tint: 'rgba(249,115,22,0.08)', ink: '#1A0800', ink2: '#6A3010', ink3: '#C07848', rule: '#FFD8A8', ruleStrong: '#FFC090',
    primary: '#F97316', primaryHover: '#EA6C0C', primaryText: '#FFFFFF',
    accent1: '#F97316', accent2: '#22C55E', accent3: '#FACC15', accent4: '#818CF8', accent5: '#F43F5E',
    alert: '#F43F5E', warn: '#FACC15', ok: '#22C55E', info: '#818CF8',
    navBg: '#FFFFFF', navText: '#C07848', navActiveText: '#F97316', navActiveBg: 'rgba(249,115,22,0.08)', navActiveBorder: '#F97316',
    headerBg: '#FFFFFF', headerText: '#1A0800', headerBorder: '#FFD8A8',
  },
  ...
  components: {
    ...
    table: { style: 'minimal', headerBg: '#FFF8F0', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#FFD8A8', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#FFC090', focusBorderColor: '#F97316', bg: '#FFFFFF', labelSize: '12px', inputSize: '16px' },
