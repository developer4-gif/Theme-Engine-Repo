...
const theme: Theme = {
  id: 'password-vault',
  name: 'Password Vault',
  description: 'Dark secure vault — biometric lock, credential cards, password strength bars, encrypted feel. Inspired by password manager mobile apps.',
  category: 'productivity',
  tags: ["productivity","security","mobile","dark","secure","vault","password","privacy"],
  brand: { name: 'Password Vault', tagline: '', logo: '', logoAlt: 'Password Vault', favicon: '', stripeColors: ['#00BFFF', '#0D1117', '#3FB950', '#0D1117', '#00BFFF'], stripeHeight: 3 },
  colors: {
    bg: '#0D1117', bgSecondary: '#161B22', bgTertiary: '#21262D', panel: '#161B22', panelSecondary: '#0D1117',
    tint: 'rgba(0,191,255,0.08)', ink: '#FFFFFF', ink2: '#8B949E', ink3: '#484F58', rule: '#21262D', ruleStrong: '#30363D',
    primary: '#00BFFF', primaryHover: '#00A0D0', primaryText: '#0D1117',
    accent1: '#00BFFF', accent2: '#3FB950', accent3: '#F0883E', accent4: '#BC8CFF', accent5: '#F85149',
    alert: '#F85149', warn: '#F0883E', ok: '#3FB950', info: '#BC8CFF',
    navBg: '#0D1117', navText: '#484F58', navActiveText: '#00BFFF', navActiveBg: 'rgba(0,191,255,0.08)', navActiveBorder: '#00BFFF',
    headerBg: '#0D1117', headerText: '#FFFFFF', headerBorder: '#21262D',
  },
  ...
  components: {
    ...
    card: { style: 'bordered', radius: '10px', padding: '20px', shadow: '0 2px 16px rgba(0,0,0,0.08)', borderWidth: '0px', accentWidth: '0px', accentPosition: 'none' },
    table: { style: 'minimal', headerBg: '#161B22', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#21262D', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#30363D', focusBorderColor: '#00BFFF', bg: '#161B22', labelSize: '12px', inputSize: '16px' },
