...
const theme: Theme = {
  id: 'gig-economy',
  name: 'Gig Economy',
  description: 'Dynamic gig work — job listings, earnings dashboard, task map, payout tracking. Inspired by gig & freelance mobile apps.',
  category: 'startup',
  tags: ["gig","work","mobile","blue","dynamic","earnings","jobs","freelance"],
  brand: { name: 'Gig Economy', tagline: '', logo: '', logoAlt: 'Gig Economy', favicon: '', stripeColors: ['#3B82F6', '#FFFFFF', '#10B981', '#FFFFFF', '#3B82F6'], stripeHeight: 3 },
  colors: {
    bg: '#FFFFFF', bgSecondary: '#F0F8FF', bgTertiary: '#E0F0FF', panel: '#FFFFFF', panelSecondary: '#F0F8FF',
    tint: 'rgba(59,130,246,0.06)', ink: '#0A1628', ink2: '#2A4878', ink3: '#6888C8', rule: '#C0D8F0', ruleStrong: '#A0C0E8',
    ...
    navBg: '#FFFFFF', navText: '#6888C8', navActiveText: '#3B82F6', navActiveBg: 'rgba(59,130,246,0.06)', navActiveBorder: '#3B82F6',
    headerBg: '#3B82F6', headerText: '#FFFFFF', headerBorder: '#2563EB',
  },
  ...
  components: {
    ...
    table: { style: 'minimal', headerBg: '#F0F8FF', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#C0D8F0', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#A0C0E8', focusBorderColor: '#3B82F6', bg: '#FFFFFF', labelSize: '12px', inputSize: '16px' },
