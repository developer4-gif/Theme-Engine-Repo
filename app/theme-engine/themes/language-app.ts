...
const theme: Theme = {
  id: 'language-app',
  name: 'Language App',
  description: 'Bright language learning — streak flames, XP progress, audio lessons, flag cards. Inspired by language learning mobile apps.',
  category: 'education',
  tags: ["education","language","mobile","green","bright","streak","gamified","learning"],
  brand: { name: 'Language App', tagline: '', logo: '', logoAlt: 'Language App', favicon: '', stripeColors: ['#58CC02', '#FFFFFF', '#FF4B4B', '#FFFFFF', '#58CC02'], stripeHeight: 3 },
  colors: {
    bg: '#FFFFFF', bgSecondary: '#F7FCF7', bgTertiary: '#EDFAED', panel: '#FFFFFF', panelSecondary: '#F7FCF7',
    tint: 'rgba(88,204,2,0.08)', ink: '#1A3000', ink2: '#4A7020', ink3: '#80B040', rule: '#C8E880', ruleStrong: '#A8D860',
    primary: '#58CC02', primaryHover: '#49AB00', primaryText: '#FFFFFF',
    accent1: '#58CC02', accent2: '#FF4B4B', accent3: '#FFD700', accent4: '#1CB0F6', accent5: '#CE82FF',
    alert: '#CE82FF', warn: '#FFD700', ok: '#FF4B4B', info: '#1CB0F6',
    navBg: '#FFFFFF', navText: '#80B040', navActiveText: '#58CC02', navActiveBg: 'rgba(88,204,2,0.08)', navActiveBorder: '#58CC02',
    headerBg: '#FFFFFF', headerText: '#1A3000', headerBorder: '#C8E880',
  },
  ...
  components: {
    ...
    table: { style: 'minimal', headerBg: '#F7FCF7', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#C8E880', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#A8D860', focusBorderColor: '#58CC02', bg: '#FFFFFF', labelSize: '12px', inputSize: '16px' },
