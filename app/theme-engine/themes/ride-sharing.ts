...
const theme: Theme = {
  id: 'ride-sharing',
  name: 'Ride Sharing',
  description: 'Dark ride-sharing — map overlay, driver cards, trip fare, rating stars, ETA countdown. Inspired by ridesharing & mobility mobile apps.',
  category: 'navigation',
  tags: ["navigation","mobile","dark","ride","map","driver","fare","transit"],
  brand: { name: 'Ride Sharing', tagline: '', logo: '', logoAlt: 'Ride Sharing', favicon: '', stripeColors: ['#00B984', '#1C1C1E', '#FFD60A', '#1C1C1E', '#00B984'], stripeHeight: 3 },
  colors: {
    bg: '#1C1C1E', bgSecondary: '#2C2C2E', bgTertiary: '#3A3A3C', panel: '#2C2C2E', panelSecondary: '#1C1C1E',
    tint: 'rgba(0,185,132,0.10)', ink: '#FFFFFF', ink2: '#EBEBF5', ink3: '#8E8E93', rule: '#3A3A3C', ruleStrong: '#48484A',
    primary: '#00B984', primaryHover: '#009E70', primaryText: '#FFFFFF',
    accent1: '#00B984', accent2: '#FFD60A', accent3: '#FF453A', accent4: '#0A84FF', accent5: '#BF5AF2',
    alert: '#BF5AF2', warn: '#FF453A', ok: '#FFD60A', info: '#0A84FF',
    navBg: '#1C1C1E', navText: '#8E8E93', navActiveText: '#00B984', navActiveBg: 'rgba(0,185,132,0.10)', navActiveBorder: '#00B984',
    headerBg: '#1C1C1E', headerText: '#FFFFFF', headerBorder: '#3A3A3C',
  },
  typography: { fontSans: '"SF Pro Text", system-ui, sans-serif', fontSerif: '"Georgia", serif', fontMono: '"SF Mono", monospace', headingFont: 'sans', xs: '10px', sm: '12px', base: '14px', md: '16px', lg: '18px', xl: '22px', '2xl': '28px', '3xl': '36px', '4xl': '48px', regular: 400, medium: 500, semibold: 600, bold: 700, tight: 1.15, normal: 1.55, relaxed: 1.75, tight_ls: '-0.01em', normal_ls: '0em', wide_ls: '0.02em', wider_ls: '0.05em' },
  ...
  components: {
    ...
    form: { style: 'outlined', radius: '10px', borderColor: '#48484A', focusBorderColor: '#00B984', bg: '#2C2C2E', labelSize: '12px', inputSize: '16px' },
