...
const theme: Theme = {
  ...
  description: 'Fresh nutrition tracking — macro rings, food diary, calorie cards, clean health green. Inspired by calorie & nutrition tracker mobile apps.',
  category: 'health',
  tags: ["health","nutrition","mobile","green","fresh","macro","calorie","food"],
  brand: { name: 'Nutrition Track', tagline: '', logo: '', logoAlt: 'Nutrition Track', favicon: '', stripeColors: ['#38A138', '#FFFFFF', '#FF6B35', '#FFFFFF', '#38A138'], stripeHeight: 3 },
  colors: {
    bg: '#FFFFFF', bgSecondary: '#F4FAF4', bgTertiary: '#E8F5E8', panel: '#FFFFFF', panelSecondary: '#F4FAF4',
    tint: 'rgba(56,161,56,0.06)', ink: '#0D2010', ink2: '#2A5030', ink3: '#70A070', rule: '#C0E0C0', ruleStrong: '#98C898',
    primary: '#38A138', primaryHover: '#2D8A2D', primaryText: '#FFFFFF',
    accent1: '#38A138', accent2: '#FF6B35', accent3: '#FFD700', accent4: '#4ECDC4', accent5: '#FF4444',
    alert: '#FF4444', warn: '#FFD700', ok: '#FF6B35', info: '#4ECDC4',
    navBg: '#FFFFFF', navText: '#70A070', navActiveText: '#38A138', navActiveBg: 'rgba(56,161,56,0.06)', navActiveBorder: '#38A138',
    headerBg: '#FFFFFF', headerText: '#0D2010', headerBorder: '#C0E0C0',
  },
  ...
  components: {
    ...
    card: { style: 'elevated', radius: '14px', padding: '20px', shadow: '0 2px 16px rgba(0,0,0,0.08)', borderWidth: '0px', accentWidth: '0px', accentPosition: 'none' },
    table: { style: 'minimal', headerBg: '#F4FAF4', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#C0E0C0', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#98C898', focusBorderColor: '#38A138', bg: '#FFFFFF', labelSize: '12px', inputSize: '16px' },
