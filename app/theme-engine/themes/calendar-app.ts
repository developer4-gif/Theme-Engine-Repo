...
const theme: Theme = {
  id: 'calendar-app',
  name: 'Calendar App',
  description: 'Clean calendar scheduling — month grid, event chips, agenda list, color-coded categories. Inspired by calendar & scheduling mobile apps.',
  category: 'productivity',
  tags: ["productivity","calendar","mobile","white","clean","schedule","events","time"],
  brand: { name: 'Calendar App', tagline: '', logo: '', logoAlt: 'Calendar App', favicon: '', stripeColors: ['#10B981', '#FFFFFF', '#3B82F6', '#FFFFFF', '#10B981'], stripeHeight: 3 },
  colors: {
    bg: '#FFFFFF', bgSecondary: '#F8F9FA', bgTertiary: '#F1F3F5', panel: '#FFFFFF', panelSecondary: '#F8F9FA',
    tint: 'rgba(16,185,129,0.06)', ink: '#111827', ink2: '#374151', ink3: '#9CA3AF', rule: '#E5E7EB', ruleStrong: '#D1D5DB',
    ...
    navBg: '#FFFFFF', navText: '#9CA3AF', navActiveText: '#10B981', navActiveBg: 'rgba(16,185,129,0.06)', navActiveBorder: '#10B981',
  ...
  components: {
    ...
    table: { style: 'minimal', headerBg: '#F8F9FA', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#E5E7EB', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#D1D5DB', focusBorderColor: '#10B981', bg: '#FFFFFF', labelSize: '12px', inputSize: '16px' },
