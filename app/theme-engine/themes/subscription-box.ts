...
const theme: Theme = {
  ...
  description: 'Elegant subscription — discovery cards, box contents reveal, billing summary, curated picks. Inspired by subscription box mobile apps.',
  category: 'startup',
  tags: ["subscription","box","mobile","purple","elegant","discovery","curated","consumer"],
  brand: { name: 'Subscription Box', tagline: '', logo: '', logoAlt: 'Subscription Box', favicon: '', stripeColors: ['#8B5CF6', '#FAF8FF', '#EC4899', '#FAF8FF', '#8B5CF6'], stripeHeight: 3 },
  colors: {
    bg: '#FAF8FF', bgSecondary: '#F0E8FF', bgTertiary: '#E4D0FF', panel: '#FFFFFF', panelSecondary: '#FAF8FF',
    tint: 'rgba(139,92,246,0.06)', ink: '#1A0840', ink2: '#5A2880', ink3: '#A070C8', rule: '#DDD0F0', ruleStrong: '#C0A0E0',
    ...
    navBg: '#FFFFFF', navText: '#A070C8', navActiveText: '#8B5CF6', navActiveBg: 'rgba(139,92,246,0.06)', navActiveBorder: '#8B5CF6',
    headerBg: '#FFFFFF', headerText: '#1A0840', headerBorder: '#DDD0F0',
  },
  ...
  components: {
    ...
    table: { style: 'minimal', headerBg: '#F0E8FF', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#DDD0F0', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#C0A0E0', focusBorderColor: '#8B5CF6', bg: '#FFFFFF', labelSize: '12px', inputSize: '16px' },
