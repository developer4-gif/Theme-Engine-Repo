...
const theme: Theme = {
  ...
  description: 'Dark academic university — lecture schedules, campus map, grade tracker, rich navy tone. Inspired by university & campus mobile apps.',
  category: 'education',
  tags: ["education","university","mobile","dark","navy","academic","campus","schedule"],
  brand: { name: 'University Dark', tagline: '', logo: '', logoAlt: 'University Dark', favicon: '', stripeColors: ['#3B82F6', '#0F1B2D', '#10B981', '#0F1B2D', '#3B82F6'], stripeHeight: 3 },
  colors: {
    bg: '#0F1B2D', bgSecondary: '#152234', bgTertiary: '#1C2D45', panel: '#1C2D45', panelSecondary: '#152234',
    tint: 'rgba(59,130,246,0.10)', ink: '#FFFFFF', ink2: '#94A8C8', ink3: '#4A6080', rule: '#1C2D45', ruleStrong: '#2C3D55',
    primary: '#3B82F6', primaryHover: '#2563EB', primaryText: '#FFFFFF',
    accent1: '#3B82F6', accent2: '#10B981', accent3: '#F59E0B', accent4: '#8B5CF6', accent5: '#EF4444',
    alert: '#EF4444', warn: '#F59E0B', ok: '#10B981', info: '#8B5CF6',
    navBg: '#0F1B2D', navText: '#4A6080', navActiveText: '#3B82F6', navActiveBg: 'rgba(59,130,246,0.10)', navActiveBorder: '#3B82F6',
    headerBg: '#0F1B2D', headerText: '#FFFFFF', headerBorder: '#1C2D45',
  },
  ...
  components: {
    ...
    table: { style: 'minimal', headerBg: '#152234', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#1C2D45', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#2C3D55', focusBorderColor: '#3B82F6', bg: '#1C2D45', labelSize: '12px', inputSize: '16px' },
