...
const theme: Theme = {
  id: 'parking-finder',
  name: 'Parking Finder',
  description: 'Midnight blue parking — slot availability map, timer countdown, payment flow, booking confirmation. Inspired by parking & urban mobility apps.',
  category: 'navigation',
  tags: ["navigation","parking","mobile","dark","blue","map","booking","timer"],
  brand: { name: 'Parking Finder', tagline: '', logo: '', logoAlt: 'Parking Finder', favicon: '', stripeColors: ['#6366F1', '#0A1020', '#10B981', '#0A1020', '#6366F1'], stripeHeight: 3 },
  colors: {
    bg: '#0A1020', bgSecondary: '#12182E', bgTertiary: '#1A2240', panel: '#1A2240', panelSecondary: '#12182E',
    tint: 'rgba(99,102,241,0.10)', ink: '#FFFFFF', ink2: '#8898CC', ink3: '#4858A0', rule: '#1A2240', ruleStrong: '#283060',
    primary: '#6366F1', primaryHover: '#4F46E5', primaryText: '#FFFFFF',
    accent1: '#6366F1', accent2: '#10B981', accent3: '#FBBF24', accent4: '#F43F5E', accent5: '#A78BFA',
    alert: '#A78BFA', warn: '#FBBF24', ok: '#10B981', info: '#F43F5E',
    navBg: '#0A1020', navText: '#4858A0', navActiveText: '#6366F1', navActiveBg: 'rgba(99,102,241,0.10)', navActiveBorder: '#6366F1',
    headerBg: '#0A1020', headerText: '#FFFFFF', headerBorder: '#1A2240',
  },
  ...
  components: {
    ...
    table: { style: 'minimal', headerBg: '#12182E', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#1A2240', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#283060', focusBorderColor: '#6366F1', bg: '#1A2240', labelSize: '12px', inputSize: '16px' },
