...
const theme: Theme = {
  id: 'marketplace',
  name: 'Marketplace',
  description: 'Clean marketplace — product listings, seller profiles, bid buttons, category browse. Inspired by peer-to-peer marketplace mobile apps.',
  category: 'startup',
  tags: ["marketplace","shopping","mobile","white","clean","listings","seller","consumer"],
  brand: { name: 'Marketplace', tagline: '', logo: '', logoAlt: 'Marketplace', favicon: '', stripeColors: ['#10B981', '#FFFFFF', '#3B82F6', '#FFFFFF', '#10B981'], stripeHeight: 3 },
  colors: {
    bg: '#FFFFFF', bgSecondary: '#F8F8F8', bgTertiary: '#F0F0F0', panel: '#FFFFFF', panelSecondary: '#F8F8F8',
    tint: 'rgba(16,185,129,0.06)', ink: '#1A1A1A', ink2: '#4A4A4A', ink3: '#8A8A8A', rule: '#E0E0E0', ruleStrong: '#CCCCCC',
    primary: '#10B981', primaryHover: '#059669', primaryText: '#FFFFFF',
    accent1: '#10B981', accent2: '#3B82F6', accent3: '#F59E0B', accent4: '#8B5CF6', accent5: '#EF4444',
    alert: '#EF4444', warn: '#F59E0B', ok: '#3B82F6', info: '#8B5CF6',
    navBg: '#FFFFFF', navText: '#8A8A8A', navActiveText: '#10B981', navActiveBg: 'rgba(16,185,129,0.06)', navActiveBorder: '#10B981',
    headerBg: '#FFFFFF', headerText: '#1A1A1A', headerBorder: '#E0E0E0',
  },
  ...
  components: {
    ...
    table: { style: 'minimal', headerBg: '#F8F8F8', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#E0E0E0', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#CCCCCC', focusBorderColor: '#10B981', bg: '#FFFFFF', labelSize: '12px', inputSize: '16px' },
