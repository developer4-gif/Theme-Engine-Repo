...
const theme: Theme = {
  id: 'creator-studio',
  name: 'Creator Studio',
  description: 'Deep creator dark — content dashboard, analytics, audience cards, revenue charts. Inspired by content creator mobile apps.',
  category: 'tech',
  tags: ["creator","content","mobile","dark","purple","analytics","audience","revenue"],
  brand: { name: 'Creator Studio', tagline: '', logo: '', logoAlt: 'Creator Studio', favicon: '', stripeColors: ['#A855F7', '#0D0D15', '#10B981', '#0D0D15', '#A855F7'], stripeHeight: 3 },
  colors: {
    bg: '#0D0D15', bgSecondary: '#151523', bgTertiary: '#1E1E30', panel: '#1E1E30', panelSecondary: '#151523',
    tint: 'rgba(168,85,247,0.10)', ink: '#FFFFFF', ink2: '#A094C8', ink3: '#6056A0', rule: '#1E1E30', ruleStrong: '#2A2A45',
    primary: '#A855F7', primaryHover: '#9333EA', primaryText: '#FFFFFF',
    accent1: '#A855F7', accent2: '#10B981', accent3: '#F59E0B', accent4: '#3B82F6', accent5: '#EF4444',
    alert: '#EF4444', warn: '#F59E0B', ok: '#10B981', info: '#3B82F6',
    navBg: '#0D0D15', navText: '#6056A0', navActiveText: '#A855F7', navActiveBg: 'rgba(168,85,247,0.10)', navActiveBorder: '#A855F7',
    headerBg: '#0D0D15', headerText: '#FFFFFF', headerBorder: '#1E1E30',
  },
  ...
  components: {
    ...
    table: { style: 'minimal', headerBg: '#151523', rowHoverBg: 'rgba(0,0,0,0.03)', borderColor: '#1E1E30', cellPaddingX: '16px', cellPaddingY: '12px', fontSize: '14px', headerFontSize: '11px', stripeColor: 'rgba(0,0,0,0.02)', density: 'relaxed' },
    form: { style: 'outlined', radius: '10px', borderColor: '#2A2A45', focusBorderColor: '#A855F7', bg: '#1E1E30', labelSize: '12px', inputSize: '16px' },
